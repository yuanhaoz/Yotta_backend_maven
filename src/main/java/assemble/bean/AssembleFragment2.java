 ...
 */
public class AssembleFragment2 {
    ...
    public AssembleFragment2() {

    }

    public AssembleFragment2(String fragmentContent, String text, String fragmentScratchTime, int termID, String termName, String facetName, int facetLayer, String className, String sourceName) {
    ...
    public AssembleFragment2(int fragmentID, String fragmentContent, String text, String fragmentScratchTime, int termID, String termName, String facetName, int facetLayer, String className, String sourceName) {
